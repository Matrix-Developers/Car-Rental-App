    ...
    public class LocacaoAppService : AppServiceBase<Locacao>
    {
        ...
        public override bool InserirEntidade(Locacao locacao)
        {
            ...
            if (resultado)
                ...
                Log.Error("{DataEHora} / Feature: {Feature} / Layer: {Layer} / Module: {Module} / Registro: {Id} {Tempo}ms", DateTime.Now, this.ToString(), "AppService", "Inserir", locacao,tempo);
        ...
        public override bool ExcluirEntidade(int id)
        {
            ...
            if (resultado)
                ...
                Log.Error("{DataEHora} / Feature: {Feature} / Layer: {Layer} / Module: {Module} / Registro: {Id} {Tempo}ms", DateTime.Now, this.ToString(), "AppService", "Inserir", id,tempo);
        ...
        public override Locacao SelecionarEntidadePorId(int id)
        {
            ...
            if(locacao != null)
                ...
                Log.Error("{DataEHora} / Feature: {Feature} / Layer: {Layer} / Module: {Module} / Registro: {Id} {Tempo}ms", DateTime.Now, this.ToString(), "AppService", "Selecionar por id", id,tempo);
        ...
        public override List<Locacao> SelecionarTodasEntidade()
        {
            ...
            if (locacoes != null)
                ...
                Log.Error("{DataEHora} / Feature: {Feature} / Layer: {Layer} / Module: {Module} / Registro: {Id} {Tempo}ms", DateTime.Now, this.ToString(), "AppService", "Selecionar todos", locacoes.Count,tempo);
