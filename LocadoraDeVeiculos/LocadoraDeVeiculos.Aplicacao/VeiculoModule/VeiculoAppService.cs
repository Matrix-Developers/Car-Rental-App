    ...
    public class VeiculoAppService : AppServiceBase<Veiculo>
    {
        ...
        public override bool InserirEntidade(Veiculo veiculo)
        {
            ...
            if (resultado)
                ...
                Log.Error("{DataEHora} / Feature: {Feature} / Camada: AppService / Módulo: Inserir / ID Registro: {Id}", DateTime.Now, this.ToString(), veiculo.Id,tempo);
        ...
        public override bool EditarEntidade(int id, Veiculo veiculo)
        {
            ...
            if (resultado)
                ...
                Log.Error("{DataEHora} / Feature: {Feature} / Camada: {Camada} / Módulo: {Modulo} / Registro: {Id}", DateTime.Now, this.ToString(), "AppService", "Inserir", veiculo,tempo);
