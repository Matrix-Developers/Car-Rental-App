    ...
    public partial class TabelaVeiculoControl : UserControl
    {
        ...
        public void AtualizarRegistros(List<Veiculo> veiculos)
        {
            ...
            foreach (Veiculo veiculo in veiculos)
                gridVeiculos.Rows.Add(veiculo.Id, veiculo.modelo, veiculo.grupoVeiculos, veiculo.placa, veiculo.chassi, veiculo.marca, veiculo.cor, veiculo.tipoCombustivel, veiculo.capacidadeTanque, veiculo.ano, veiculo.kilometragem, veiculo.numeroPortas, veiculo.capacidadePessoas, veiculo.tamanhoPortaMala, veiculo.temArCondicionado, veiculo.temDirecaoHidraulica, veiculo.temFreiosAbs );
        }
    }
}
