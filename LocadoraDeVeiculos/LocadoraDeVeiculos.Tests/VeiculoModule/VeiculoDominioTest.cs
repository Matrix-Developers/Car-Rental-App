...
namespace LocadoraDeVeiculos.Tests.VeiculoModule
{
    ...
    public class VeiculoTest
    {
        ...
        {
            Veiculo veiculo = new Veiculo(0, "Ecosport", null, "LPT-4652", "4DF56F78E8WE9WED", "Ford", "Prata", "Gasolina Comum", 60.5, 2018, 30000, 4, 5, 'G', true, true, true,true);
        ...
        {
            Veiculo veiculo = new Veiculo(0, "", null, "", "", "", "", "", 0, 0, 0, 0, 0, 'a', false, false, false,false);
